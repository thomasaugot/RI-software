...
const HierarchyUserCard: FC<hierarchyUserCardProps> = ({
  employee,
  inTeam,
  setHierarchy,
  hierarchy,
  ...
  return (
    <div
      className={`${
        userId
          ? `user-card-container ${active && userId ? "user-card-container-active" : ""}`
          : "user-card-container-placeholder"
      }`}
      onClick={(e) => {
        e.stopPropagation();
        getEmployeesData();
    ...
    >
      ...
      <div className="user-card-info">
        {userId ? <p className="user-card-info-name">{name}</p> : null}
      ...
      {inTeam ? (
        <div className="user-card-functions-container">
          <div className="user-card-functions-buttons-container">
            <div
              className="user-card-functions-fire"
              onClick={(e) => {
                e.stopPropagation();
            ...
            {userId ? (
              <div
                className="user-card-functions-move"
                onClick={(e) => {
                  e.stopPropagation();
                  ...
                  setMoveWorkerData({
                    ...
                    newLeaderId: -1,
                    team: employeeTeam ? employeeTeam : false,
                  });
                }}
              >
                {moveEmployeeButton}
              ...
              <div
                className="user-card-functions-replace"
                onClick={(e) => {
                  e.stopPropagation();
          ...
          <div className="user-card-functions-edit"></div>
        </div>
      ) : (
        <></>
      )}
